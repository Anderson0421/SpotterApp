...
export default function Navbar() {
    ...
    return (
        <>
            <div className="flex justify-end items-center dark:border-gray-600 dark:border-b  dark:bg-dashboard-third h-16 w-full max-sm:hidden fixed z-10 bg-white">
                <ul className="p-5 flex items-center justify-between gap-7">
